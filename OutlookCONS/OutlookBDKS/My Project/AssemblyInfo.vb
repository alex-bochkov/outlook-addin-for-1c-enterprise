...
<Assembly: AssemblyTitle("Outlook + 1С:Консолидация")> 
<Assembly: AssemblyDescription("Надстройка для интеграции Outlook и 1С:Консолидация 8" + _
             vbNewLine + "" + _
...
<Assembly: AssemblyProduct("Outlook + 1С:Консолидация")> 
